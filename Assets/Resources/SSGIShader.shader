...
CGINCLUDE
// Common code used by several SSGI passes below
...
float4 _Params; // x=radius, y=minz, z=attenuation power, w=SSGI power

#if defined(SHADER_API_XBOX360)|| defined(SHADER_API_D3D11)

#	define INPUT_SAMPLE_COUNT 8
#	include "frag_gi.cginc"
...
half4 frag (v2f_gi i) : COLOR
{
    ...
    return frag_gi (i, SAMPLE_COUNT, RAND_SAMPLES);
}
ENDCG

	}

// ---- SSGI pass, 14 samples
	Pass {
...
half4 frag( v2f i ) : COLOR
{
    ...
    half sum = tex2D(_SSGI, i.uv).r * (NUM_BLUR_SAMPLES + 1);
